...
public class Reservation {
  ...
  @Builder
  public Reservation(LocalDateTime reservationTime, LocalDateTime bringTime, Integer price,
      Member member, List<ReservationInfo> reservationInfos) {
  ...
  public void updateReservationType() {
    reservationType = reservationType.equals(ReservationType.REQUEST) ? ReservationType.ACCEPT
