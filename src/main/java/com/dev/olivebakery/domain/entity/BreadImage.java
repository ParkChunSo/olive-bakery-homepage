...
public class BreadImage {
  ...
  public static BreadImage of(MultipartFile imageFile, Bread bread, String imagePath)
      throws IOException {
  ...
  public static String calcPath(String uploadPath) {
    ...
    String monthPath = yearPath + File.separator + new DecimalFormat("00")
        .format(cal.get(Calendar.MONTH) + 1); // 월 별 폴더 경로

    String datePath = monthPath + File.separator + new DecimalFormat("00")
        .format(cal.get(Calendar.DATE)); // 일 별 폴더 경로
