...
public class BreadListDao {
  ...
  public BreadListDao(Long breadId, String breadName, Integer breadPrice, String description,
      String detailDescription, DayType days, Boolean isSoldOut, BreadState state,
      String ingrediantName, String ingrediantOrigin, String imageUrl) {
