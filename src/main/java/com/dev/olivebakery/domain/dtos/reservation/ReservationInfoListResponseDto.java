...
public class ReservationInfoListResponseDto {
    ...
    @Builder
    public ReservationInfoListResponseDto(Long reservationId, LocalDateTime reservationTime, LocalDateTime bringTime, int price, String memberName, List<ReservationBreadDto> reservationBreads) {
    ...
    public static ReservationInfoListResponseDto of(ReservationInfoListTmpDto reservationResponseTemp, List<ReservationBreadDto> reservationBreads) {
