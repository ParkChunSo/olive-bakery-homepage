...
public class BreadListResponseDto {
  ...
  @Builder
  public BreadListResponseDto(Long breadId, String name, Integer price, String description,
      String detailDescription, List<String> days, Boolean isSoldOut, BreadState state,
      List<IngredientListResponseDto> ingredientsList, String imageUrl) {
    this.id = breadId;
    this.name = name;
    this.price = price;
