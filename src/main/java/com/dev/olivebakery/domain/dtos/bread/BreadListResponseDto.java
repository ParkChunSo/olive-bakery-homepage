...
public class BreadListResponseDto {
    ...
    private List<IngredientListResponseDto> ingredientsList;
    ...
    // querydsl 가져오기용.
    public BreadListResponseDto(String name, Integer price, String description, String detailDescription, BreadState state, String imageUrl) {
        this.name = name;
        this.price = price;
        this.description = description;
        this.detailDescription = detailDescription;
    ...
    public void setIngredientsList(List<IngredientListResponseDto> ingredientsList) {
        this.ingredientsList = ingredientsList;
    }
}