...
public class BreadDetailResponseDto {
    ...
    @Builder
    public BreadDetailResponseDto(String name, Integer price, String description, String detailDescription, List<String> days, Boolean isSoldOut, BreadState state, List<IngredientListResponseDto> ingredientsList, String imageUrl) {
        this.name = name;
        this.price = price;
