...
public class ReservationInfoListTmpDto {
    ...
    @Builder
    public ReservationInfoListTmpDto(Long reservationId, LocalDateTime reservationTime, LocalDateTime bringTime, int price, String memberName, String breadName, int breadCount) {
