...
public class ConverterUtils {
   ...
   */
  public static List<BreadListResponseDto> convertBreadDao2BreadListResponseDto(
      List<BreadListDao> breadList) {
   ...
   */
  public static BreadListResponseDto convertBreadDaoList2BreadListResponseDto(
      List<BreadListDao> daos) {
    if (daos.isEmpty()) {
   ...
   */
  public static ReservationInfoListResponseDto convertGetTmpDtoToGetDto(
      List<ReservationInfoListTmpDto> reservationResponseTemps) {
   ...
   */
  public static List<ReservationInfoListResponseDto> convertGetTempDtoListToGetDtoList(
      List<ReservationInfoListTmpDto> reservationResponseTemps) {
    ...
    for (ReservationInfoListTmpDto reservationResponseTemp : reservationResponseTemps) {
      if (reservationResponseTemp.getReservationId().equals(reservationId)) {
        ...
        if (reservationResponseTemps.indexOf(reservationResponseTemp)
            == reservationResponseTemps.size() - 1) {
          reservationResponses.add(ReservationInfoListResponseDto.of(reservationResponseTemps
                  .get(reservationResponseTemps.indexOf(reservationResponseTemp)),
              reservationBreads)
          );
        }
        continue;
      ...
      reservationResponses.add(ReservationInfoListResponseDto.of(reservationResponseTemps
              .get(reservationResponseTemps.indexOf(reservationResponseTemp) - 1),
          reservationBreads));
