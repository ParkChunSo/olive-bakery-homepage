...
import com.dev.olivebakery.domain.dtos.sales.*;
...
public class SalesService {
    ...
    public List<GraphDataDto> getAverageAnnualSales(){
        List<GraphDao> averageSales = salesRepository.getAverageSales(DayType.YEAR.name(), LocalDate.now());
    ...
    public List<GraphDataDto> getAverageMonthlySales(int year) {
        List<GraphDao> averageSales = salesRepository.getAverageSales(DayType.MONTH.name(), LocalDate.of(year, 1, 1));
        if(averageSales.isEmpty())
            return null;
    ...
    public List<GraphDataDto> getDailySales(int year, int month) {
        List<GraphDao> averageSales = salesRepository.getAverageSales(DayType.DAY.name(), LocalDate.of(year, month, 1));
        if(averageSales.isEmpty())
            return null;
