...
public class ReservationController {
  ...
  public List<ReservationInfoListResponseDto> getReservationInfos(
  ...
  public ReservationInfoListResponseDto getReservationInfosByDate(
      @RequestHeader(name = "Authorization") String bearerToken) {
  ...
  public List<ReservationInfoListResponseDto> getReservationInfosByAdminRole(
  ...
  public List<ReservationInfoListResponseDto> getReservationInfosByDate(
      @RequestBody ReservationDateRequestDto request,
      @RequestHeader(name = "Authorization") String bearerToken) {
  ...
  public List<ReservationInfoListResponseDto> getReservationInfosByDateRange(
      @RequestBody ReservationDateRangeRequestDto request,
      @RequestHeader(name = "Authorization") String bearerToken) {
