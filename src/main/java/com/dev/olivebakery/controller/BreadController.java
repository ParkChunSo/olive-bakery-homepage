...
public class BreadController {
  ...
  @PostMapping
  public void saveBreadAndImage(@RequestPart MultipartFile file, @RequestParam String json) throws Exception {
  ...
  @PutMapping
  public void updateBread(@RequestPart(name = "file", required = false) MultipartFile file, @RequestParam String json) throws Exception {
    BreadRequestDto breadSave = objectMapper.readValue(json, BreadRequestDto.class);
