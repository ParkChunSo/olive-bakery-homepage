...
public class SalesController {
  ...
  public List<GraphDataDto> getDailySales(@PathVariable("year") int year,
  ...
  public List<DashBoardDto> getDashData(@PathVariable("year") int year,
      @PathVariable("month") int month) {
  ...
  public SaveSalesDto getSaleInfo(@PathVariable("year") int year, @PathVariable("month") int month,
